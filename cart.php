            ...
            <div class="shop-page-content">
                ...
                <div class="rec">
                    ...
                    <table>
                        <thead class="block">
                        <tr>
                            <th align="center" class="text140">Product</th>
                            <th align="center" class="text140">Price</th>
                            <th align="center" class="text140">Quantity</th>
                            <th align="center" class="text140">Subtotal</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>
                                <div class="cart-info">
                                    <img class="imgmask" src="img/Asgaard sofa 3.png">
                                    <span class="text143">Asgaard sofa </span>
                                </div>
                            </td>
                            <td class="text143">Rs. 250,000.00</td>
                            <td><input class="rec138" type="number" value="1"></td>
                            <td>
                                Rs. 250,000.00
                    ...
                    <div class="two">
                        <div>
                            <h5 align="center" class="cart-total-text">Cart Total</h5>
                        </div>
                        <table align="center" class="subtotal">
                            <tr>
                            <th align="center" class="text140">
                                Subtotal
                            </th>
                                <th class="text143">Rs. 250,000.00</th>
                            </tr>
                            <tr>
                            <td align="center" class="text140">
                                Total
                            </td>
                                <td class="subtotal-text">Rs. 250,000.00</td>
                            </tr>
                        </table>
                            <div align="center">
